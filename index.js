  ...
  noticia: [
    {
      ...
      resumo: `Desde que a computação surgiu, pessoas mal intencionadas utilizam conhecimentos em programação para criar códigos maliciosos, que danificam o computador, roubam dados dos usuários, entre outros malefícios. O assunto é sério: alguns programas são capazes até mesmo de captar tudo o que digitamos no teclado. 
      Por isso, prevenir-se é fundamental.E é justamente para combater essas pragas virtuais que foram criados os antivírus. Mas você sabe o que é antivírus? Vamos desvendar como funcionam esses programas mantidos por grandes empresas de segurança e descobrir algumas das melhores opções disponíveis. Ficou curioso? Então acompanhe!`,
    },
    {
      ...
      resumo: `Com os hackers cada vez mais ágeis e as ameaças à nossa segurança online crescendo vertiginosamente, as informações de login estão se tornando cada vez mais delicadas e valiosas. Criar senhas realmente seguras exige ao menos uma letra maiúscula, símbolo, número, o nome da tia-avó da sua vizinha do lado esquerdo, e coisas do tipo. Mas como se lembrar de todas essas senhas, uma vez que é indicado usar combinações diferentes para cada login?
    ...
    },
    {
      ...
      categoria: "intermediario",
      url: "ttps://blog.convisoappsec.com/owasp-e-sua-importancia/",
      resumo: `A segurança de aplicativos e softwares de computadores é simplesmente uma das etapas mais importantes do planejamento para o desenvolvimento. Afinal, o nível de confiabilidade é o que determinará o sucesso dele, e isso se refletirá no número de usuários ativos no aplicativo, por exemplo. E não tem como falar em segurança sem mencionar o OWASP.`,
    },
    {
